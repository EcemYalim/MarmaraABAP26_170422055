...
CLASS lcl_eml_service IMPLEMENTATION.
  ...
  METHOD save_user.
    ...
    MODIFY ENTITIES OF zr_usr_170422055 ENTITY ZrUsr170422055
        CREATE FIELDS (
            id
            username
            firstname
    ...
    IF lt_failed IS INITIAL.
      ...
      mo_out->write( 'EML INSERT SUCCESSFUL' ).

    ELSE.

      mo_out->write(  'EML INSERT FAILED' ).
    ENDIF.
