CLASS zcl_170422055_230226 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_170422055_230226 IMPLEMENTATION.
...
**********************************************************************
    ...
    out->write( ls_attendance ).
    APPEND ls_attendance TO lt_attendance.  ""tabloya ekleme
    ...
    ls_attendance = VALUE #( student_number = 1234567895 student_name = |Esma| student_lastname = |Yorulmaz| ).
